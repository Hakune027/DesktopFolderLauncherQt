...
Window {
    ...
    function openForFolderWindow() {
        ...
        let targetScreen = folderWindow && folderWindow.screen ? folderWindow.screen : root.screen;
        let desiredX = folderWindow ? folderWindow.x + Math.round((folderWindow.width - root.width) / 2) : root.x;
        let desiredY = folderWindow ? folderWindow.y + Math.round((folderWindow.height - root.height) / 2) : root.y;
        ...
        if (targetScreen) {
            ...
            let areaWidth = area ? area.width : (targetScreen.desktopAvailableWidth || targetScreen.width || root.width);
            let areaHeight = area ? area.height : (targetScreen.desktopAvailableHeight || targetScreen.height || root.height);
            desiredX = Math.max(areaX, Math.min(desiredX, areaX + Math.max(0, areaWidth - root.width)));
            desiredY = Math.max(areaY, Math.min(desiredY, areaY + Math.max(0, areaHeight - root.height)));
        }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        onMoved: if (root.folderData)
                            root.folderData.cornerRadius = value
                ...
                CheckBox {
                    text: "启用磨砂玻璃（使用 Windows 系统圆角）"
                    checked: root.folderData && root.folderData.frostedGlass
                    onClicked: {
                        if (root.folderData)
                            root.folderData.frostedGlass = checked;
                        root.persist();
                    }
                    ToolTip.visible: hovered
                    ToolTip.text: "开启后禁用自定义圆角，并强制使用 Windows 11 系统窗口圆角"
                }
                ...
                RowLayout {
                    ...
                    RadioButton {
                        ...
                        onClicked: {
                            if (root.folderData)
                                root.folderData.backgroundStyle = "black";
                            root.persist();
                        }
                    }
                    RadioButton {
                        ...
                        onClicked: {
                            if (root.folderData)
                                root.folderData.backgroundStyle = "white";
                            root.persist();
                        }
                    }
                }
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        onMoved: if (root.folderData)
                            root.folderData.backgroundOpacity = value
                        onPressedChanged: if (!pressed)
                            root.persist()
                    }
                    Label {
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        onMoved: if (root.folderData)
                            root.folderData.iconSize = value
                        onPressedChanged: if (!pressed)
                            root.persist()
                    }
                    Label {
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        onMoved: if (root.folderData)
                            root.folderData.iconSpacing = value
                        onPressedChanged: if (!pressed)
                            root.persist()
                    }
                    Label {
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        onMoved: if (root.folderData)
                            root.folderData.edgePadding = value
                        onPressedChanged: if (!pressed)
                            root.persist()
                    }
                    Label {
                ...
                CheckBox {
                    ...
                    onClicked: {
                        if (root.folderData)
                            root.folderData.showFolderName = checked;
                        root.persist();
                    }
                }
                ...
                CheckBox {
                    ...
                    onClicked: {
                        if (root.folderData)
                            root.folderData.showIconNames = checked;
                        root.persist();
                    }
                }
                ...
                CheckBox {
                    ...
                    onClicked: {
                        if (root.folderData)
                            root.folderData.showIconShadow = checked;
                        root.persist();
                    }
                }
                ...
                CheckBox {
                    ...
                    onClicked: {
                        if (root.folderData)
                            root.folderData.allowIconGaps = checked;
                        root.persist();
                    }
                    ToolTip.visible: hovered
                ...
                CheckBox {
                    ...
                    onClicked: {
                        if (root.folderData)
                            root.folderData.lockPosition = checked;
                        root.persist();
                    }
                }
